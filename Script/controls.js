...
Tangle.controls.c_filterKnob = function (el, worksheet) {
	...
	var knobEl = new Element("img", { style:knobStyle, src:"http://worrydream.com/ExplorableExplanations/Media/FilterParamsKnob.png", width:knobWidth, height:knobHeight });
